...
public class MiniMaxOpening {
	...
	public static void main(String[] args) {
		...
		// Perform the MiniMaxOening for white
		outputPattern o = MiniMaxOpenings(depth, detailsBoard, 1);
	...
	// Finding optimal move with MiniMax for white Opening
	public static outputPattern MiniMaxOpenings(int d, MorrisGameBoardState detailsBoard, int flag) {
